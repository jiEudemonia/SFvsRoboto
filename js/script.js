$(document).ready(function() {
  ...
  $(window).resize(function() {
    if ($(this).width() <= 960) {
      ...
      visted_left = 0;
      visted_right = 0;
      visted_largeScreen = false;
    } else if(visted_largeScreen == false) {
      $('.indicator2').show();
      $(".background").css({ "left" : "50%"});
      $(".showcase_ro").css({ "left" : "0"});
      visted_largeScreen = true;
      }
  });
  ...
  $('.container').click(function(){
    ...
    $("#goto_ro").click(function() {
      $("body").animate({scrollTop: $("#goto_sf").offset().top}, 900);
    });

    $("#goto_sf").click(function() {
